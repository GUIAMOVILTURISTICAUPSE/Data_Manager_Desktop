...
public class FlexBox extends Pane
{
     ...
     * Sin embargo, la propiedad de orden controla el orden en que aparecen en el contenedor flexible
     *
     * @param child el hijo de un FlexBox
     * @param value el orden en que aparece el hijo en el contenedor flexible
     */
    ...
    /**
     * Esto define la capacidad de un elemento flexible para crecer si es necesario.
     * Acepta un valor sin unidades que sirve como una proporción.
     * Indica qué cantidad de espacio disponible dentro del contenedor flexible debe ocupar el artículo.
     * Si todos los artículos tienen un crecimiento flexible establecido en 1, el espacio restante en el contenedor se distribuirá por igual a todos los hijos.
     * Si uno de los hijos tiene un valor de 2, el espacio restante ocuparía el doble de espacio que los demás (o lo intentará, al menos).
     *
     * @param child el hijo de un FlexBox
...
//        return super.computePrefHeight(width);
    ...
    protected void layoutChildren()
    {
        ...
        /**
         * Primero, transformamos todos los Nodos a FlexBoxItem para propósitos de almacenamiento en caché.
         */
