...
public class RestApiSyncGateway implements Filter { 
    ...
    public @Bean
    Cluster cluster() {
        return CouchbaseCluster.create(configurarCouchBaseEnvironment(),serverHostname);
    }
    ...
    public Object getRecursoById(@PathVariable("todoId") String todoId) {
        return DatabaseForRest.getById(bucket(), todoId);
    }

    @RequestMapping(value="/todo", method= RequestMethod.GET)
    public Object getAllRecursos() {
        return DatabaseForRest.getAll(bucket());
    }
